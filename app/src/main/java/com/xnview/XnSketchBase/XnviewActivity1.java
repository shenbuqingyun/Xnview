 ...
 * 描述
 */
public class XnviewActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xnviewAdapter1.setOnItemClickListener(new XnviewAdapter1.onRecyclerViewItemClick() {
            ...
            public void onItemClick(View v, int pos) {
                doItemClick(pos);
                Toast.makeText(XnviewActivity1.this, String.valueOf(pos), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void doItemClick(int pos){
        ...
        XnSketchActivity.invokeEffect(paramBitmap1, xnviewBitmap, 3, 25, 0, 100 - 48, 0, 0, 0, 0, 0);
