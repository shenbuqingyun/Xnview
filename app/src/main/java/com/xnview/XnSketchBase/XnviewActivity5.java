 ...
 * 描述
 */
public class XnviewActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xnviewAdapter1.setOnItemClickListener(new XnviewAdapter1.onRecyclerViewItemClick() {
            ...
            public void onItemClick(View v, int pos) {
                doItemClick(pos);
                Toast.makeText(XnviewActivity5.this, String.valueOf(pos), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void doItemClick(int pos){
        ...
        XnSketchActivity.invokeEffect(paramBitmap1, xnviewBitmap, 9, 0, 0, 0, 0, 0, 0, 0, 0);
